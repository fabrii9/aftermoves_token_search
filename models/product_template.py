...
class ProductTemplate(models.Model):
    ...
    def name_search(self, name='', args=None, operator='ilike', limit=100):
        ...
        El name_search estándar de product.template NO llama a super(),
        por lo que el mixin no se ejecuta por el MRO normal.
        """
        # Llamar al name_search estándar de Odoo (product_template.py)
        original_results = super(ProductTemplate, self).name_search(
